...
export class ComicStoryGeneratorNode extends CustomNode {
  process(context: ProcessContext, input: ComicStoryInput): GraphTypes.LLMChatRequest {
    console.log(`📝 Generating comic story for characters: "${input.character1Description}" and "${input.character2Description}"`);
      ...
      panels: [
        {
          ...
          visualDescription: "A simple illustration showing an error message, drawn in comic book style"
        },
        {
          panelNumber: 2,
